...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' - ' : ''; ?>Recruiter App</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand" href="<?php echo base_url(); ?>">Recruiter App</a>
    ...
    <footer class="bg-light py-4 mt-5">
        <div class="container text-center">
            <p class="mb-0">&copy; <?php echo date('Y'); ?> Recruiter App. All rights reserved.</p>
        </div>
    </footer>
