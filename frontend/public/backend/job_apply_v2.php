<?php
// API endpoint for handling detailed job applications - SIMPLIFIED WITH NO AUTH VALIDATION
...
function debugLog($message, $data = null) {
    $logFile = __DIR__ . '/apply_v2_debug.log';
...
debugLog("Received detailed application request", [
...
try {
    ...
    // Get job information from form data
    ...
    // Get form data fields - simplified to only required fields
    ...
    // Combine all data - simplified version
    $application = [
        'id' => $application_id,
        'job_id' => $job_id,
        'user_id' => $user_id,
    ...
    debugLog("Created detailed application", $application);
    ...
    debugLog("Updated applications.json with detailed application");
    ...
    debugLog("Detailed application submitted successfully", ['id' => $application_id]);
    
} catch (Exception $e) {
    debugLog("Exception in detailed application", ['message' => $e->getMessage(), 'trace' => $e->getTraceAsString()]);
